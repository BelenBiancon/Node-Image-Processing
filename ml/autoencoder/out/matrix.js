    ...
    var Matrix = (function () {
        ...
        Matrix.prototype.mean = function (axis) {
            ...
            if (axis == 0) {
                ...
                return ml.Vector.create(sums).multiply(1.0 / rows);
            }
            else if (axis == 1) {
                for (var i = 0; i < rows; i++) {
                    sums[i] = 0;
                ...
                return ml.Vector.create(sums).multiply(1.0 / cols);
            }
        };
        Matrix.prototype.max = function () {
            var row = this.elements.length, max = 0.0, tmp = 0;
            for (var i = 0; i < row; i++) {
        ...
        Matrix.prototype.min = function () {
            var row = this.elements.length, min = Number.MAX_VALUE, tmp = 0;
            for (var i = 0; i < row; i++) {
